...
class MixtralSparseMoeBlock(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        # sent_emb = router_logits.view(batch_size, sequence_length, -1)[:, -1, :] # prompteol
...
class MixtralDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # print('hidden_states fed into block_sparse_moe: ', hidden_states.shape)
        hidden_states, router_logits, sent_emb = self.block_sparse_moe(hidden_states)
        hidden_states = residual + hidden_states
