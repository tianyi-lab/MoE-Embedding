...
class Qwen2MoeConfig(PretrainedConfig):
    ...
    Args:
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            Expected contents:
                `rope_type` (`str`):
                    The sub-variant of RoPE to use. Can be one of ['HS', 'linear', 'dynamic', 'yarn', 'longrope',
                    'llama3'], with 'HS' being the original RoPE implementation.
                `factor` (`float`, *optional*):
                    Used with all rope types except 'HS'. The scaling factor to apply to the RoPE embeddings. In
